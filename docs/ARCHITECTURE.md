...
both `1.1.2` for this maintenance release; the earlier `1.0.0~rc4`, `1.0.0`
`1.0.1`, `1.0.2` and `1.1.0` releases sort below it, so `apt` upgrades normally. Stable internal Winspace IDs/paths remain for
