...
**Current status: 1.0.0 is published; this source tree prepares a local 1.1.1 maintenance build.** A built
...
Semantic and Debian versions are `1.1.1`. For each later release, bump both,
