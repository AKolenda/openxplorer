# OpenXplorer 1.0.0-rc.3 — tabs and desktop routing
...
```sh
sudo apt install './openxplorer_1.0.0~rc3_all.deb'
openxplorer --restart
```
...
File-icon dragging outside a window remains separate and is not implemented by
this patch; the shared Ctrl+C/Ctrl+X/Ctrl+V file clipboard remains available.
