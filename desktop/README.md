...
From this directory after building, use `./dist/openxplorer_1.1.2_all.deb` instead. Never run the file manager with sudo. The optional administrative mount helper is a separate command.
