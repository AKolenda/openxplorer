...
def main():
    ...
    with sync_playwright() as pw:
        ...
        try:
            ...
            check('Version 1.1.1 is visible','1.1.1' in page.locator('#status-right').inner_text() if page.locator('#status-right').count() else '1.1.1' in page.locator('body').inner_text())
