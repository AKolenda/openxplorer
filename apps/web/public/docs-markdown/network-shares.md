...
![Actual SMB address bar with clickable server, share and directory segments](../assets/screenshots/network-path.png)
...
![A sample Design folder pinned in the real sidebar, with its network marker](../assets/screenshots/pinned-sidebar.png)
